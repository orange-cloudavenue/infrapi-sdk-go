...
// List of tagVRF
const (
	STANDARD_TagVrf TagVrf = "VRF_STANDARD"
	PREMIUM_TagVrf TagVrf = "VRF_PREMIUM"
	DEDICATED_MEDIUM_TagVrf TagVrf = "VRF_DEDICATED_MEDIUM"
	DEDICATED_LARGE_TagVrf TagVrf = "VRF_DEDICATED_LARGE"
)
