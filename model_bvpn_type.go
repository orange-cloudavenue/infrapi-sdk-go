 ...
 */
package cloudavenue
// BvpnType : Type of BVPN connectivity, bvpnico being to create interco with FCA orgs
type BvpnType string

// List of bvpnType
const (
	BVPN_BvpnType BvpnType = "bvpn"
	BVPNICO_BvpnType BvpnType = "bvpnico"
)
