...
type FederationStatusType string

// List of federation-status-type
const (
	LOCAL_FederationStatusType FederationStatusType = "local"
	SIU_FederationStatusType FederationStatusType = "siu"
)
