...
/*
JobsApiService Returns a job status by ID.
...
func (a *JobsApiService) GetJobById(ctx context.Context, jobId string) ([]ParentJobMetadata, *http.Response, error) {
	var (
		...
		localVarReturnValue []ParentJobMetadata
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/customers/v1.0/jobs/{Job-Id}"
