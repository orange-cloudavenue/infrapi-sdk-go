...
type PublicIpsNetworkConfig struct {
	UplinkIp string `json:"uplinkIp"`
	TranslatedIp string `json:"translatedIp"`
	// The name of the edge gateway related to the public ip. This properties is only present for NGP.
	EdgeGatewayName string `json:"edgeGatewayName,omitempty"`
}
